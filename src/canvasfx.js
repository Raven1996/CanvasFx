...
function normalBlurEffect(radius, gamma, mask, type, centerX, centerY){
	var imgData = ctxA.getImageData(0, 0, canvasA.width, canvasA.height);
	var pxData = imgData.data;
	...
	var power = Math.exp(2.3*gamma);  // 0 ~ 1 remap the value
...
function lenBlurEffect(radius, gamma, mask, centerX, centerY){
	var imgData = ctxA.getImageData(0, 0, canvasA.width, canvasA.height);
	var pxData = imgData.data;
	var tmpPxArr = [];
	var fullH = canvasB.height, fullW = canvasB.width;
...
function motionBlurEffect(length, degree, gamma, mask, centerX, centerY){
	var imgData = ctxA.getImageData(0, 0, canvasA.width, canvasA.height);
	var pxData = imgData.data;
	var tmpPxArr = [];
	var fullH = canvasB.height, fullW = canvasB.width;
...
function zoomBlurEffect(strength, gamma, type, centerX, centerY){
	var imgData = ctxA.getImageData(0, 0, canvasA.width, canvasA.height);
	var pxData = imgData.data;
	var tmpPxArr = [];
	var fullH = canvasB.height, fullW = canvasB.width;
